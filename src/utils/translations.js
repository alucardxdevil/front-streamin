const translations = {
  es: {
    ...
    termsSubtitle: "En StreamIn nos importa que entiendas tus derechos y responsabilidades. Hemos escrito estos términos de la forma más clara posible.",
    ...
    acceptTermsContent: "Al acceder y utilizar StreamIn, aceptas estos Términos y Condiciones en su totalidad. Si no estás de acuerdo con alguna parte, te pedimos que no utilices la plataforma.",
    acceptTermsHighlight: "📌 El uso continuado de StreamIn después de cualquier modificación constituye tu aceptación de los términos actualizados.",
    serviceDescription: "Descripción del Servicio",
    serviceDescContent: "StreamIn es una plataforma de streaming que permite a los usuarios:",
    ...
    userAccountsContent: "Para utilizar ciertas funciones de StreamIn, necesitarás crear una cuenta. Al hacerlo, te comprometes a:",
    ...
    contentIPContent: "Tú conservas los derechos sobre el contenido que subes a StreamIn. Sin embargo, al publicar contenido, nos otorgas una licencia mundial, no exclusiva, libre de regalías para usar, reproducir, modificar, distribuir y mostrar dicho contenido dentro de la plataforma.",
    ...
    contentIPHighlight: "🎵 Si subes música o audio que no es tuyo, asegúrate de contar con las licencias correspondientes. StreamIn no se hace responsable por infracciones de derechos de autor cometidas por usuarios.",
    prohibitedConduct: "Conducta Prohibida",
    prohibitedConductContent: "Para mantener StreamIn como un espacio seguro y respetuoso, está prohibido:",
    ...
    prohibitedItem4: "Intentar hackear, descompilar o interferir con los sistemas de StreamIn",
    ...
    monetizationContent: "StreamIn ofrece opciones de monetización para creadores elegibles. Los términos específicos incluyen:",
    ...
    monetizationItem3: "StreamIn se reserva el derecho de modificar las tasas de monetización",
    ...
    liabilityContent: 'StreamIn se proporciona "tal cual" y "según disponibilidad". En la máxima medida permitida por la ley:',
    ...
    liabilityItem3: "Nuestra responsabilidad total no excederá el monto que hayas pagado a StreamIn en los últimos 12 meses",
    ...
    indemnificationContent: "Aceptas indemnizar y mantener indemne a StreamIn, sus directores, empleados y afiliados de cualquier reclamación, daño, pérdida o gasto (incluyendo honorarios legales) que surja de:",
    ...
    indemnificationItem4: "El contenido que publiques en StreamIn",
    ...
    termsFooter: "© 2025 StreamIn. Todos los derechos reservados. Si tienes dudas sobre estos términos, no dudes en",
    ...
    discoverPopular: "Descubre lo más popular en StreamIn",
  ...
  en: {
    ...
    termsSubtitle: "At StreamIn we care that you understand your rights and responsibilities. We have written these terms as clearly as possible.",
    ...
    acceptTermsContent: "By accessing and using StreamIn, you accept these Terms and Conditions in their entirety. If you disagree with any part, we ask that you do not use the platform.",
    acceptTermsHighlight: "📌 Continued use of StreamIn after any modification constitutes your acceptance of the updated terms.",
    serviceDescription: "Service Description",
    serviceDescContent: "StreamIn is a streaming platform that allows users to:",
    ...
    userAccountsContent: "To use certain features of StreamIn, you will need to create an account. By doing so, you agree to:",
    ...
    contentIPContent: "You retain the rights to the content you upload to StreamIn. However, by publishing content, you grant us a worldwide, non-exclusive, royalty-free license to use, reproduce, modify, distribute and display such content within the platform.",
    ...
    contentIPHighlight: "🎵 If you upload music or audio that is not yours, make sure you have the corresponding licenses. StreamIn is not responsible for copyright infringements committed by users.",
    prohibitedConduct: "Prohibited Conduct",
    prohibitedConductContent: "To keep StreamIn a safe and respectful space, the following is prohibited:",
    ...
    prohibitedItem4: "Attempting to hack, decompile or interfere with StreamIn's systems",
    ...
    monetizationContent: "StreamIn offers monetization options for eligible creators. Specific terms include:",
    ...
    monetizationItem3: "StreamIn reserves the right to modify monetization rates",
    ...
    liabilityContent: 'StreamIn is provided "as is" and "as available". To the maximum extent permitted by law:',
    ...
    liabilityItem3: "Our total liability shall not exceed the amount you have paid to StreamIn in the last 12 months",
    ...
    indemnificationContent: "You agree to indemnify and hold harmless StreamIn, its directors, employees and affiliates from any claim, damage, loss or expense (including legal fees) arising from:",
    ...
    indemnificationItem4: "The content you publish on StreamIn",
    ...
    termsFooter: "© 2025 StreamIn. All rights reserved. If you have questions about these terms, feel free to",
    ...
    discoverPopular: "Discover what's most popular on StreamIn",
  ...
  pt: {
    ...
    termsSubtitle: "No StreamIn nos importamos que você entenda seus direitos e responsabilidades. Escrevemos estes termos da forma mais clara possível.",
    lastUpdated: "Última atualização: Janeiro 2025",
    acceptTerms: "Aceitação dos Termos",
    acceptTermsContent: "Ao acessar e utilizar o StreamIn, você aceita estes Termos e Condições em sua totalidade. Se não concordar com alguma parte, pedimos que não utilize a plataforma.",
    acceptTermsHighlight: "📌 O uso continuado do StreamIn após qualquer modificação constitui sua aceitação dos termos atualizados.",
    serviceDescription: "Descrição do Serviço",
    serviceDescContent: "StreamIn é uma plataforma de streaming que permite aos usuários:",
    ...
    userAccountsContent: "Para utilizar certas funções do StreamIn, você precisará criar uma conta. Ao fazê-lo, você se compromete a:",
    ...
    contentIPContent: "Você mantém os direitos sobre o conteúdo que envia ao StreamIn. No entanto, ao publicar conteúdo, você nos concede uma licença mundial, não exclusiva, livre de royalties para usar, reproduzir, modificar, distribuir e exibir tal conteúdo dentro da plataforma.",
    ...
    contentIPHighlight: "🎵 Se você enviar música ou áudio que não é seu, certifique-se de ter as licenças correspondentes. O StreamIn não se responsabiliza por infrações de direitos autorais cometidas por usuários.",
    prohibitedConduct: "Conduta Proibida",
    prohibitedConductContent: "Para manter o StreamIn como um espaço seguro e respeitoso, é proibido:",
    ...
    prohibitedItem4: "Tentar hackear, descompilar ou interferir nos sistemas do StreamIn",
    ...
    monetizationContent: "O StreamIn oferece opções de monetização para criadores elegíveis. Os termos específicos incluem:",
    ...
    monetizationItem3: "O StreamIn reserva-se o direito de modificar as taxas de monetização",
    ...
    liabilityContent: 'O StreamIn é fornecido "como está" e "conforme disponibilidade". Na máxima extensão permitida por lei:',
    ...
    liabilityItem3: "Nossa responsabilidade total não excederá o valor que você pagou ao StreamIn nos últimos 12 meses",
    ...
    indemnificationContent: "Você concorda em indenizar e manter indene o StreamIn, seus diretores, funcionários e afiliados de qualquer reclamação, dano, perda ou despesa (incluindo honorários legais) decorrente de:",
    ...
    indemnificationItem4: "O conteúdo que você publicar no StreamIn",
    ...
    termsFooter: "© 2025 StreamIn. Todos os direitos reservados. Se tiver dúvidas sobre estes termos, não hesite em",
    ...
    discoverPopular: "Descubra o que é mais popular no StreamIn",
  ...
  de: {
    ...
    termsSubtitle: "Bei StreamIn ist es uns wichtig, dass du deine Rechte und Pflichten verstehst. Wir haben diese Bedingungen so klar wie möglich formuliert.",
    lastUpdated: "Zuletzt aktualisiert: Januar 2025",
    acceptTerms: "Annahme der Bedingungen",
    acceptTermsContent: "Durch den Zugriff auf und die Nutzung von StreamIn akzeptierst du diese Allgemeinen Geschäftsbedingungen in vollem Umfang. Wenn du mit einem Teil nicht einverstanden bist, nutze die Plattform bitte nicht.",
    acceptTermsHighlight: "📌 Die fortgesetzte Nutzung von StreamIn nach Änderungen gilt als Zustimmung zu den aktualisierten Bedingungen.",
    serviceDescription: "Beschreibung des Dienstes",
    serviceDescContent: "StreamIn ist eine Streaming-Plattform, die es Nutzern ermöglicht:",
    ...
    userAccountsContent: "Um bestimmte Funktionen von StreamIn zu nutzen, musst du ein Konto erstellen. Dabei erklärst du dich einverstanden:",
    ...
    contentIPContent: "Du behältst die Rechte an den Inhalten, die du auf StreamIn hochlädst. Durch die Veröffentlichung gewährst du uns jedoch eine weltweite, nicht-exklusive, lizenzgebührenfreie Lizenz zur Nutzung, Vervielfältigung, Änderung, Verbreitung und Anzeige dieser Inhalte innerhalb der Plattform.",
    ...
    contentIPHighlight: "🎵 Wenn du Musik oder Audio hochlädst, die nicht dir gehört, stelle sicher, dass du die entsprechenden Lizenzen besitzt. StreamIn haftet nicht für Urheberrechtsverletzungen durch Nutzer.",
    prohibitedConduct: "Verbotenes Verhalten",
    prohibitedConductContent: "Um StreamIn zu einem sicheren und respektvollen Ort zu machen, ist Folgendes untersagt:",
    ...
    prohibitedItem4: "Versuchen, die Systeme von StreamIn zu hacken, zu dekompilieren oder zu stören",
    ...
    monetizationContent: "StreamIn bietet Monetarisierungsoptionen für berechtigte Ersteller. Spezifische Bedingungen umfassen:",
    ...
    monetizationItem3: "StreamIn behält sich das Recht vor, Monetarisierungsraten zu ändern",
    ...
    liabilityContent: 'StreamIn wird "wie besehen" und "wie verfügbar" bereitgestellt. Im gesetzlich zulässigen Umfang:',
    ...
    liabilityItem3: "Ist unsere Gesamthaftung auf den Betrag begrenzt, den du in den letzten 12 Monaten an StreamIn gezahlt hast",
    ...
    indemnificationContent: "Du erklärst dich damit einverstanden, StreamIn, seine Direktoren, Mitarbeiter und Partner von allen Ansprüchen, Schäden, Verlusten oder Kosten (einschließlich Anwaltsgebühren) freizustellen, die entstehen aus:",
    ...
    indemnificationItem4: "Den von dir auf StreamIn veröffentlichten Inhalten",
    ...
    termsFooter: "© 2025 StreamIn. Alle Rechte vorbehalten. Wenn du Fragen zu diesen Bedingungen hast, kannst du uns gerne",
    ...
    discoverPopular: "Entdecke, was bei StreamIn am beliebtesten ist",
