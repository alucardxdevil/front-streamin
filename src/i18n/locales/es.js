...
export default {
  ...
  "betaBannerMessage": "stream-in está en versión beta. Si quieres apoyar el mantenimiento de la plataforma, puedes hacer una donación o contribución.",
  ...
  "usAboutPageSubtitle": "stream-in es una plataforma nueva de streaming en fase beta. Aquí explicamos nuestra visión, cómo pensamos la experiencia de quienes ven y crean contenido, y qué límites defendemos.",
  "usAboutPageBetaLine": "Versión beta · Abril 2026",
  "usSecWhatTitle": "Qué es stream-in",
  "usSecWhatP1": "stream-in nace como una alternativa de streaming con las ideas recientes: menos muros arbitrarios sobre lo que se puede decir, y más foco en que la herramienta sirva de verdad a la audiencia y a quien produce contenido.",
  ...
  "usSecExperienceP2": "stream-in está diseñada para crecer junto con los anunciantes (no en contra): una experiencia segura para marcas y centrada en el usuario, donde la promoción apoya el ecosistema sin convertirse en el producto principal.",
  ...
  "usSecLimitsP1": "Defendemos la libertad de expresión y rechazamos la censura desmedida, pero eso no convierte a stream-in en un espacio sin reglas. Estamos en contra de todo contenido que busque dañar, explotar o discriminar.",
  ...
  "usAboutFooter": "© 2026 stream-in — Plataforma en beta. Gracias por formar parte de este arranque.",
  ...
  "uploadBetaLimitsHint": "Beta stream-in: hasta 800 MB por vídeo y 10 MB por miniatura.",
