...
export default {
  ...
  "lightTheme": "Light",
  "sunsetTheme": "Sunset",
  "betaBannerMessage": "stream-in is in beta. If you want to support platform maintenance, you can make a donation or contribution.",
  ...
  "advertiseFeatAudienceDesc": "Wide demographic reach in a multilingual community: connect with users across all languages available on stream-in.",
  ...
  "usAboutPageSubtitle": "stream-in is a new streaming platform in beta. Here we share our vision, how we think about the experience for viewers and creators, and the boundaries we stand by.",
  "usAboutPageBetaLine": "Beta release · April 2026",
  "usSecWhatTitle": "What is stream-in?",
  "usSecWhatP1": "stream-in is built as a streaming alternative with a modern take: fewer arbitrary walls around what can be said, and more focus on the product actually serving audiences and people who make content.",
  ...
  "usSecExperienceP2": "stream-in is built to grow with advertisers (not against them): a brand-safe, user-first experience where promotion supports the ecosystem instead of becoming the main product.",
  ...
  "usSecLimitsP1": "We support freedom of expression and reject over-censorship, but stream-in is not a rule-free zone. We oppose content meant to harm, exploit, or discriminate.",
  ...
  "usAboutFooter": "© 2026 stream-in — Beta platform. Thank you for being part of this launch.",
  ...
  "uploadBetaLimitsHint": "stream-in beta: up to 800 MB per video and 10 MB per thumbnail.",
